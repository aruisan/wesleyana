    ...
    <section class="section pt-md-5 pb-md-5">
      <div class="container">
        <div class="row mb-5 justify-content-center element-animate">
          <div class="col-md-12">
            <span class="section-heading">Children Ministries</span>
            <h2>"Train up a child in the way he should go: and when he is old, he will not depart from it." &mdash; Proverbs 22:6 KJV</h2>
          </div>
        </div>
        <div class="row">
          <div class="col-md-6">
          ...
          <div class="col-md-6">
            <p><img src="{{asset('/plantilla_advent/img/img_1.jpg')}}" alt="Image placeholder" class="img-fluid"></p>
      ...
      <div class="container">
        <div class="row mb-5 justify-content-center element-animate">
          <div class="col-md-12">
            ...
            <h2>Children Ministry Sermons</h2>
          </div>
        </div>
        <div class="row">
